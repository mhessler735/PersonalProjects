...
var score_value = 100
var Laser = preload("res://Variant/Enemy2/EnemyLaser2.tscn")
var enemy_explosion = preload("res://Variant/Enemy2/EnemyShipExplosion2.tscn")
var speed = 150
var follow
...
func _ready():
	...
	randomize()
	var path = $EnemyPaths2.get_children()[randi() % $EnemyPaths2.get_child_count()]
